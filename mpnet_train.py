...
parser.add_argument('--data-path', type=str, default='../milestone2/')
...
parser.add_argument('--start-epoch', type=int, default=10000)
parser.add_argument('--device', type=int, default=0, help='cuda device')

parser.add_argument('--env-type', type=str, default='c3d')
