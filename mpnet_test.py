...
if __name__ == '__main__':
    ...
    parser.add_argument('--NP', type=int, default=50, help='number of paths per environment')
    ...
    parser.add_argument('--epoch', type=int, default=13000, help='epoch of trained model to use')
